 ...
 */
  (function (window, undefined) {
    ...
    let sortOrder = function () { return 0; };
 ...
 */
    function addHandle(attrs, handler, test) {
      ...
      const setHandle = test ? null : handler;
 ...
 */
    function boolHandler(elem, name) {
      ...
      const val = elem.getAttributeNode(name);
 ...
 */
	...
	---------------------------------------------------------------------- */
      ...
      // Should return 1, but returns 4 (following)
		 div1.compareDocumentPosition(doc.createElement('div')) & 1
                           )
                                                 )
                                                                                                   )
                                                           )
        ...
        CHILD: function (type, what, argument, first, last) {
          ...
          // Shortcut for :nth-*(n)
            ...
            : function (elem, context, xml) {
              ...
              let name = ofType && elem.nodeName.toLowerCase();


              let useCache = !xml && !ofType;
...
var i = seed.length;
    ...
    function tokenize(selector, parseOnly) {
      ...
      let cached = tokenCache[`${selector } `];
    ...
    function addCombinator(matcher, combinator, base) {
      ...
      let checkNonElements = base && dir === 'parentNode';
    ...
    function matcherFromTokens(tokens) {
      ...
      let leadingRelative = Expr.relative[tokens[0].type];


      let implicitRelative = leadingRelative || Expr.relative[' '];
      ...
      let matchContext = addCombinator((elem) => ( {
        return elem === checkContext;
      }, implicitRelative, true);


      let matchAnyContext = addCombinator((elem) => ( {
    ...
    function matcherFromGroupMatchers(elementMatchers, setMatchers) {
      ...
      let superMatcher = function (seed, context, xml, results, expandContext) {
        ...
        let outermost = expandContext != null;


        let contextBackup = outermostContext;

        // We must always have either seed elements or context

        let elems = seed || byElement && Expr.find.TAG('*', expandContext && context.parentNode || context);
...
var stateString = tuple[3];
    ...
    when(subordinate /* , ..., subordinateN */) {
      ...
      var progressValues; let progressContexts; let 
        resolveContexts;
  ...
  function internalData(elem, name, data, pvt /* Internal Use Only */) {
    ...
    let isNode = elem.nodeType;


    // Only DOM nodes need the global jQuery cache; JS object data is
    // attached directly to the object so GC can occur automatically

    let cache = isNode ? jQuery.cache : elem;
  ...
  function internalRemoveData(elem, name, pvt) {
    ...
    let id = isNode ? elem[jQuery.expando] : jQuery.expando;
  ...
  let rclickable = /^(?:a|area)$/i;


  let ruseDefault = /^(?:checked|selected)$/i;


  let getSetAttribute = jQuery.support.getSetAttribute;


  let getSetInput = jQuery.support.input;
...
var nType = elem.nodeType;
  ...
  let rmouseEvent = /^(?:mouse|contextmenu)|click/;
 ...
 */
  jQuery.event = {
    ...
    add(elem, types, handler, data, selector) {
      ...
      var special; let eventHandle; let handleObj;


      var handlers; let type; let namespaces; let origType;
    ...
    remove(elem, types, handler, selector, mappedTypes) {
      ...
      var origCount; let t; let events;


      var special; let handlers; let type;


      var namespaces; let origType;
    ...
    trigger(event, data, elem, onlyHandlers) {
      ...
      var bubbleType; let special; let tmp; let i;
...
var form = jQuery.nodeName(elem, 'input' ) || jQuery.nodeName(elem, 'button' ) ? elem.form : undefined;
  ...
  function createSafeFragment(document) {
    ...
    let safeFrag = document.createDocumentFragment();
  ...
  jQuery.fn.extend({
    ...
    domManip(args, callback, allowIntersection) {
      ...
      var scripts; let doc; let fragment;
  ...
  function cloneCopyEvent(src, dest) {
    ...
    let oldData = jQuery._data(src);


    let curData = jQuery._data(dest, oldData);
  ...
  jQuery.extend({
    ...
    buildFragment(elems, context, scripts, selection) {
      ...
      var tmp; let tag; let tbody; let wrap;
...
var i = 0;
  ...
  if (window.getComputedStyle) {
    ...
    curCSS = function (elem, name, _computed) {
      ...
      let computed = _computed || getStyles(elem);
  ...
  function getWidthOrHeight(elem, name, extra) {
    ...
    let isBorderBox = jQuery.support.boxSizing && jQuery.css(elem, 'boxSizing', false, styles) === 'border-box';
  ...
  function actualDisplay(name, doc) {
    ...
    let display = jQuery.css(elem[0], 'display');
    elem.remove();
    return display;
  }
...
var parts = typeof value === 'string' ? value.split(' ') : [value];
  ...
  function addToPrefiltersOrTransports(structure) {
    ...
    return function (dataTypeExpression, func) {
      ...
      let dataTypes = dataTypeExpression.toLowerCase().match(core_rnotwhite) || [];
  ...
  function ajaxExtend(target, src) {
    ...
    let flatOptions = jQuery.ajaxSettings.flatOptions || {};
 ...
 */
  ...
  let xhrOnUnloadAbort = window.ActiveXObject && function () {
...
var xhr = s.xhr();
            ...
            callback = function (_, isAbort) {
              var status; var responseHeaders; var statusText; var 
responses;
  ...
  let rfxtypes = /^(?:toggle|show|hide)$/;


  let rfxnum = new RegExp('^(?:([+-])=|)(' + core_pnum + ')([a-z%]*)$', 'i');


  let rrun = /queueHooks$/;


  let animationPrefilters = [defaultPrefilter];
  ...
  function Animation(elem, properties, options) {
    ...
    let length = animationPrefilters.length;


    let deferred = jQuery.Deferred().always(() => ( {
...
var length = gotoEnd ? animation.tweens.length : 0;
  ...
  jQuery.offset = {
    ...
    setOffset(elem, options, i) {
      ...
      var props = {}; let curPosition = {}; let curTop; let 
        curLeft;
